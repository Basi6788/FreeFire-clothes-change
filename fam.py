...
<head>
    ...
    <title>RIZERxOUTFIT CHANGER - Click Vault to Equip</title>
    <style>
...
<div class="footer">RIZERxOUTFIT · All-in-One Equipper | <a href="/manual" style="color:#ffcc00;">Manual Editor</a></div>
